...
public final class MysqlDB extends DB {
	private static final String INIT_SQL = "CREATE TABLE IF NOT EXISTS FILE(FILE_NAME VARCHAR(255) NOT NULL, UPLOAD_DATE DATE NOT NULL, DESCRIPTION VARCHAR(255), FILE MEDIUMBLOB NOT NULL, PRIMARY KEY(FILE_NAME,UPLOAD_DATE))";
