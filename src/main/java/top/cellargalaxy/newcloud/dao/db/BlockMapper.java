...
public interface BlockMapper {
	...
	@Results(id = "blockResult", value = {
			@Result(property = "block_id", column = "blockId", id = true),
	...
	class BlockProvider {
		...
		private static final String block = "block=#{block}";

		public static final String insert(BlockPo blockPo) {
			String string = "insert into " + TABLE_NAME + "(block_id,block) " +
					"values(#{blockId},#{block,jdbcType=BLOB})";
