...
public interface FileInfoMapper {
	...
	class FileInfoProvider {
		...
		public static final String insert(FileInfoPo fileInfoPo) {
			...
			String string = "insert into " + TABLE_NAME + "(file_id,md5,file_length,content_type,create_time) " +
					"values(#{fileId},#{md5},#{fileLength},#{contentType},#{createTime,jdbcType=DATE})";
