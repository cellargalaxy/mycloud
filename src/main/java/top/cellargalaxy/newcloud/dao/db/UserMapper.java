...
public interface UserMapper {
	...
	class UserProvider {
		...
		public static final String insert(UserPo userPo) {
			...
			String string = "insert into " + TABLE_NAME + "(user_id,user_name,user_password,create_time,update_time) " +
					"values(#{userId},#{userName},#{userPassword},#{createTime,jdbcType=DATE},#{updateTime,jdbcType=DATE})";
